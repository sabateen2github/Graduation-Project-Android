...
class QueueControllerApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getAllQueues(branchId: kotlin.String) : kotlin.collections.List<Queue> {
        val localVariableConfig = getAllQueuesRequestConfig(branchId = branchId)
    ...
    * @return RequestConfig
    */
    fun getAllQueuesRequestConfig(branchId: kotlin.String) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                put("branchId", listOf(branchId.toString()))
    ...
    */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun switchUserLocationMode(instituteId: kotlin.String, userId: kotlin.String, queueId: kotlin.String, branchId: kotlin.String) : Unit {
        val localVariableConfig = switchUserLocationModeRequestConfig(instituteId = instituteId, userId = userId, queueId = queueId, branchId = branchId)
    ...
    * @return RequestConfig
    */
    fun switchUserLocationModeRequestConfig(instituteId: kotlin.String, userId: kotlin.String, queueId: kotlin.String, branchId: kotlin.String) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
